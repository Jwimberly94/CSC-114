...
cwd = os.getcwd()
data_path = os.path.join(cwd, "alabama_housing (1).csv")
if not os.path.exists(data_path):
    # Fallback for the original filename used in earlier versions.
    data_path = os.path.join(cwd, "alabama_housing.csv")
features = []
targets = []
months = []
